...
public class PrivGetCodeTest {
  ...
  public void verifyCode() {
    ...
    final PrivGetCode privGetCode = new PrivGetCode(parameters, privateTransactionHandler);

    final Object[] params = new Object[] {senderAddress, privacyGroupId};
    final JsonRpcRequest request = new JsonRpcRequest("1", "priv_getCode", params);

    final JsonRpcSuccessResponse response = (JsonRpcSuccessResponse) privGetCode.response(request);
